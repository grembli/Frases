...
public class VentanaInic extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Generar Frases");
        ...
        jButton2.setText("Añadir Frases");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaInic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaInic().setVisible(true);
            }
        });
    }
